                    ...
                    <tbody>
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                A fluid is a liquid, gas, or other material that continuously deforms (flows) under an
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                ...
                                atmosphere of Earth. The standard atmosphere is a unit of pressure defined as 101,325
                                Pa, which is equivalent to 760 mm Hg, 29.9212 inches Hg, or 14.696 psi
                            </td>
                        </tr>
                        <tr className="border">
                            <td className="text-center p-2 md:p-4">Fluid flow rate</td>
                            <td className="md:text-center p-2 md:p-4">
                                In fluid mechanics, the volumetric flow rate (also known as volume flow rate, rate of
                                fluid flow, or volume velocity) is the volume of fluid which passes per unit time;
                                usually it is represented by the symbol Q (sometimes V̇). The SI unit is cubic metres per
                                second (m3/s).
                            </td>
                        </tr>
                        <tr className="border">
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                Archimedes' principle states that a body immersed in a fluid is subjected to an upwards
                                force equal to the weight of the displaced fluid. Buoyant force on an object equals the
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                ...
                                condition of a fluid or plastic solid at rest, which occurs when external forces, such
                                as gravity, are balanced by a pressure-gradient force.
                            </td>
                        </tr>
                        <tr className="border">
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                Laminar flow is a type of flow pattern of a fluid in which all the particles are flowing
                                in parallel lines
                            </td>
                        </tr>
                        <tr className="border">
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                Pascal's law is a principle in fluid mechanics given by Blaise Pascal that states that a
                                pressure change at any point in a confined incompressible fluid is transmitted
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                ...
                                At low Reynolds numbers, flows tend to be dominated by laminar (sheet-like) flow, while
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                Specific gravity, or relative density , is the ratio of the density of a substance to
                                the density of a given reference material. Specific gravity for liquids is nearly always
                                measured with respect to water at its denses
                            </td>
                        </tr>
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                ...
                                pressure.The hydraulic gradient is the change in total head divided the distance over
                        ...
                        <tr className="border">
                            ...
                            <td className="md:text-center p-2 md:p-4">
                                ...
                                the boundary layer is subjected to shearing forces.
                            </td>
                        </tr>
                    </tbody>
                </table>
